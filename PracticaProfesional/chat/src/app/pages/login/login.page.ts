  ...
  cargarDatos(rol: Roles) {
    switch (rol) {
      case Roles.admin:
        ...
        break;
      case Roles.invitado:
        this.form.get('mail').setValue('invitado@invitado.com');
        this.form.get('password').setValue('222222');
        break;
        case Roles.usuario:
        this.form.get('mail').setValue('usuario@usuario.com');
        this.form.get('password').setValue('333333');
        break;
        case Roles.anonimo:
        this.form.get('mail').setValue('anonimo@anonimo.com');
        this.form.get('password').setValue('444444');
        break;
        case Roles.tester:
        this.form.get('mail').setValue('tester@tester.com');
